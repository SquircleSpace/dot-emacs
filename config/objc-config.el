(defvar objc-options-initalized nil
  "Whether options for objc-mode have been fully configured")
...
(defun set-objc-options ()
  ...
  ;; Delay the rest of setup until objc-mode is used
  (add-hook 'objc-mode-hook 'initalize-objc-options))

(defun initalize-objc-options ()
  (unless objc-options-initalized
    (setq objc-options-initalized t)
